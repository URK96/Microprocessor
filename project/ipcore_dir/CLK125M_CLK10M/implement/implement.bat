...
xst -ifn xst.scr
move CLK125M_CLK10M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK125M_CLK10M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK125M_CLK10M_exdes.ucf CLK125M_CLK10M_exdes

echo 'Running map'
map -timing -pr b CLK125M_CLK10M_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm CLK125M_CLK10M_exdes -w routed.ncd routed.v
cd ..
